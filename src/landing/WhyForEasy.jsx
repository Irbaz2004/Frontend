...
const highlights = [
    {
        ...
        desc: 'HeloZO isn\'t just an app; it\'s a digital town square. We combine job hunting, service discovery, and local shopping into a single, high-performance interface, saving you time and battery.',
                ...
                <Grid container spacing={8} alignItems="flex-start">
                    <Grid item xs={12} md={5}>
                        ...
                        >
                            ...
                            >
                                We aren't just another directory. HeloZO is a community engine designed to make local life better, faster, and more rewarding for everyone.
                            </Typography>
                        </Stack>
                    </Grid>
