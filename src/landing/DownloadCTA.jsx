...
const DownloadCTA = () => {
    ...
    useEffect(() => {
        ...
        window.addEventListener('appinstalled', () => {
            ...
            setSnackbar({ open: true, message: '🎉 HeloZO installed successfully!', severity: 'success' });
        });
    ...
    const handleInstall = async () => {
        if (isInstalled) {
            setSnackbar({ open: true, message: 'HeloZO is already installed on your device!', severity: 'info' });
            return;
        }
        ...
        if (deferredPrompt) {
            ...
            if (outcome === 'accepted') {
                setSnackbar({ open: true, message: '🎉 HeloZO is being installed!', severity: 'success' });
            } else {
