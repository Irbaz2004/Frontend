...
const problems = [
    {
        title: 'Finding shops is difficult',
        desc: 'People struggle to discover nearby grocery stores, pharmacies, and other local businesses quickly.',
        icon: <StorefrontIcon />,
    },
    {
        title: 'Rent houses are hard to find',
        desc: 'Finding verified rental homes in your locality often requires asking around or relying on outdated listings.',
        icon: <HomeIcon />,
    },
    {
        title: 'Small local jobs lack visibility',
        desc: 'Daily wage, part-time, and local job opportunities remain hidden because they are rarely posted online.',
        icon: <WorkIcon />,
    },
];
...
const solutions = [
    {
        id: 1,
        title: 'Discover Shops, Rentals & Jobs',
        subtitle: 'All in One',
        desc: 'Explore nearby shops, rental houses, and local job opportunities from a single platform.',
        icon: <CheckCircleOutlineIcon />,
        color: '#4CAF50',
        stats: '3-in-1',
        statLabel: 'Local Platform',
        features: ['Nearby Shops', 'Rental Houses', 'Local Jobs']
    },
    {
        id: 2,
        title: 'Smart Location-Based Search',
        subtitle: 'Near You',
        desc: 'Search for anything nearby—from grocery stores and pharmacies to rental homes and job openings.',
        icon: <MyLocationIcon />,
        color: '#325fec',
        stats: 'Live',
        statLabel: 'GPS Discovery',
        features: ['Nearby Results', 'Interactive Map', 'Distance Filter']
    },
    {
        id: 3,
        title: 'Verified Local Listings',
        subtitle: 'Trusted',
        desc: 'Every shop, house listing, and job post is verified to provide a safer and more reliable experience.',
        icon: <VerifiedUserIcon />,
        color: '#FF9800',
        stats: 'Trusted',
        statLabel: 'Verified Listings',
        features: ['Verified Shops', 'Verified Rentals', 'Verified Jobs']
    },
];
...
const ProblemSolution = () => {
    ...
    return (
        <Box ref={sectionRef} sx={{ bgcolor: '#ffffff', position: 'relative', overflow: 'hidden' }}>
            ...
            <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1, pt: { xs: 8, sm: 10, md: 14 } }}>
                ...
                <Box sx={{
                    ...
                    <Box sx={{ position: 'relative', zIndex: 1 }}>
                        ...
                        >
                            Empowering Communities with <span style={{ color: '#325fec' }}>HeloZO</span>
                        </Typography>
                        <Typography
                            variant="h6"
                            sx={{
                        ...
                        >
                            HeloZO connects job seekers, shop owners, and customers on one platform — making local discovery simple, fast, and reliable.
                        </Typography>
                    </Box>
                </Box>
            </Container>
            ...
            <Box id="our-solutions" ref={triggerRef} sx={{ overflow: 'hidden', bgcolor: '#ffffff' }}>
                <Container maxWidth="lg">
                    <Box sx={{
                        ...
                        <Typography sx={{
                            ...
                            How <span style={{ color: '#325fec' }}>HeloZO</span> Works
                        </Typography>
                    </Box>
