...
const NAV_CONFIG = {
    ...
    shop: [
        ...
        { label: 'Shop Mgmt', icon: <AddBoxIcon />, path: '/app/business/shop-management' },
        { label: 'Jobs', icon: <WorkIcon />, path: '/app/business/jobs' },
        { label: 'Apps', icon: <PeopleIcon />, path: '/app/business/applications' },
        { label: 'Profile', icon: <PersonIcon />, path: '/app/business/profile' },
    ],
    admin: [
        { label: 'Dashboard', icon: <DashboardIcon />, path: '/app/admin/dashboard' },
        { label: 'Businesses', icon: <StoreIcon />, path: '/app/admin/businesses' },
        { label: 'Verify', icon: <VerifiedIcon />, path: '/app/admin/verifications' },
